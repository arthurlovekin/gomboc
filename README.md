The popularized gomboc is not actually a gomboc, but such objects do exist. I want to find one.
...
2. Brute force search across parameterizations of a solid. Intuitively, I think I should be looking for objects with radial symmetry (like a helix) and no mirror symmetry.
