...
## Definition:
A gömböc, also called a mono-monostatic body, is a three-dimensional, convex, homogeneous (constant-density) body with exactly one stable equilibrium point and one unstable equilibrium point when resting on a flat surface.
...
3. Brute force search across parameterizations of a solid. Promising starting points can be derived from the above visualizer, or by doing deeper research into existing equations that come close, and then refining them.
